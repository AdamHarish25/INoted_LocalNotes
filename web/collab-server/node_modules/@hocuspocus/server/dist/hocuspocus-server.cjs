...
class OutgoingMessage {
    ...
    writeTokenSyncRequest() {
        ...
        common.writeTokenSyncRequest(this.encoder);
        return this;
    }
    ...
    apply(document, connection, reply) {
        ...
        switch (type) {
            ...
            case exports.MessageType.Auth: {
                ...
                if (authType === common.AuthMessageType.Token) {
...
class Document extends Y.Doc {
    ...
    constructor(name, yDocOptions) {
        ...
        this.saveMutex = new asyncMutex.Mutex();
        ...
        this.setUpNewConnection = async (documentName) => {
            ...
            connection.onTokenSyncCallback(async (payload) => {
                try {
                    ...
                    console.error(err);
                    const error = { ...common.Unauthorized, ...err };
