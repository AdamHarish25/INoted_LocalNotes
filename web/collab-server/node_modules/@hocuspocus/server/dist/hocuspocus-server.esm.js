import { writeTokenSyncRequest, writeAuthenticated, writePermissionDenied, AuthMessageType, WsReadyStates, ResetConnection, ConnectionTimeout, Unauthorized, Forbidden, awarenessStatesToArray } from '@hocuspocus/common';
    ...
    apply(document, connection, reply) {
        ...
        switch (type) {
            ...
            case MessageType.Awareness: {
                applyAwarenessUpdate(document.awareness, message.readVarUint8Array(), connection === null || connection === void 0 ? void 0 : connection.webSocket);
                break;
            }
            ...
            case MessageType.Auth: {
                ...
                if (authType === AuthMessageType.Token) {
                    connection === null || connection === void 0 ? void 0 : connection.callbacks.onTokenSyncCallback({
...
class Hocuspocus {
    constructor(configuration) {
        ...
        this.unloadingDocuments = new Map();
    ...
    shouldUnloadDocument(document) {
        const hasPendingWork = this.debouncer.isDebounced(`onStoreDocument-${document.name}`) ||
    ...
    async openDirectConnection(documentName, context) {
        ...
        crypto.randomUUID(), connectionConfig, context);
